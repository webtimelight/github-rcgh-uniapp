...
<!-- #ifdef MP-WEIXIN || MP-QQ || APP-PLUS || H5 -->
<script src="./js/wxs.wxs" module="wxsBiz" lang="wxs"></script>
<!-- #endif -->

<!-- app, h5使用renderjs -->
<!-- #ifdef APP-PLUS || H5 -->
<script module="renderBiz" lang="renderjs">
	import renderBiz from './js/renderjs.js';
	export default {
		mixins:[renderBiz]
	}
</script>
...
<script>
	...
	import MeScroll from './js/mescroll-uni.js';
	// 引入全局配置
	import GlobalOption from './js/mescroll-uni-option.js';
	// 引入空布局组件
	import MescrollEmpty from './components/mescroll-empty.vue';
	// 引入回到顶部组件
	import MescrollTop from './components/mescroll-top.vue';
	// 引入兼容wxs(含renderjs)写法的mixins
	import WxsMixin from './js/mixins.js'; 
...
<style>
	/* 基础 */
	@import "./css/mescroll-uni.css";
	@import "./css/mescroll-down-uni.css";
	@import "./css/mescroll-up-uni.css";
	/* 自定义 */
	@import "./css/mescroll-down.css";
	@import "./css/mescroll-up.css";
</style>
